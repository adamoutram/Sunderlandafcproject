...
<form name="sort" action="youthteam.php" method="post">
	...
	<?php
	 ...
	 $query = "SELECT * FROM youthteamsquad WHERE position = '$sort'" or die(mysqli_error());

} else { // else if you do not pass any value from select option will return this
	    $query = "SELECT * FROM youthteamsquad" or die(mysqli_error());
}
