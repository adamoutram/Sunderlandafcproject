...
<form name="sort" action="firstteam.php" method="post">
	...
	<?php
	 ...
	 $query = "SELECT * FROM firstteamsquad WHERE position = '$sort' ORDER BY Player_ID ASC" or die(mysqli_error());

} else { // else if you do not pass any value from select option will return this
	    $query = "SELECT * FROM firstteamsquad ORDER BY Player_ID ASC" or die(mysqli_error());
}
