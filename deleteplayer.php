...
<?php
	...
	$query = "DELETE FROM firstteamsquad WHERE Player_ID = '$Player_ID'" or die(mysqli_error());
	
	$result = (mysqli_query($con, $query));
	
if ($result == TRUE) {
	 echo "The Player data was successfully deleted";
}

else {
	echo "The player data could not be deleted"; }
