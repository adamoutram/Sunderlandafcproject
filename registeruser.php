...
<div id="container">
            <div id="wrapper">
                <div id="top" align="center"> User Registration </div>
                <div id="form">
                <form method="post" action="userregisterationaction.php" name="register Form" id="registerform" enctype="multipart/form-data">
                	
                    <label>Username : </label>
                    <input type="date" autocomplete="off" align="center" name="username" id="user_id" class="username" />
