...
<?php	
	...
	$query = "SELECT * FROM SAFCusers WHERE user_ID = '$user_ID'" or die(mysqli_error());


		$result = (mysqli_query($con, $query));
		
		echo "<h6 align='center'>Edit User Data</h6>";
		echo "<br />";
		echo "<form method='POST' action='edituseraction.php' name='edituser' id='edituser' enctype='multipart/form-data'>";
...
<br />
<p>Go back to Edit / Delete Users <a href="admineditplayers.php"><button type="button">Edit Users</button></a></p>
<br />
