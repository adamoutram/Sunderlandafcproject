...
<?php
	...
	echo "<table border='1', width = '1000px' id='fixturestable', color = 'red';>

<tr>

<th width ='600px'><h6>Match Report</h6></th>
		...
		while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
				...
				echo "<td>" . "<img src='/images/fixtureimages/". $row["image"] . "' alt='fixtureimage'>" . " <br /><br />
