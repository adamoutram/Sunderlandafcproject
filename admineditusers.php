...
<?php
	    ...
	    $query = "SELECT * FROM SAFCusers" or die(mysqli_error());

		$result = (mysqli_query($con, $query));
		
		echo "<br />";
		echo "<h6 align='center'>Edit / Delete User Accounts</h6>";
...
<th width ='5%'></th>
		...
		while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
				...
				echo "<td>" . "<form name='deleteuser' action='deleteuser.php' method='get'>
...
<input type='submit' value='Delete'>
		...
		"<br />";	
				...
				echo "<td>" . "<form name='edituser' action='edituser.php' method='get'>
<input type='hidden' name='user_ID' value=" . $row["user_ID"] . ">
