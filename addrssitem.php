...
<?php
 ...
 <h6 align="center">Add RSS news feed item</h6>
			<?php echo $_SESSION["rssItemNotadded"]; ?>
				<p align="center">
				
				<form method="post" action="addrssitemaction.php" name="addrssitem" id="addrssitem" enctype="multipart/form-data" >
				<table align="center" style="padding-left: 520px">
   				 <tr>
                 <td align="left">Item Title:</td> <td align="right"><input name="itemtitle" type="text"  id="itemtitle" required="required"></td>
                </tr>
				
				<tr>
				<td align="left">Item Description:</td> <td align="right"><input name="itemdescr" type="textarea" ROWS="3" COLS="30"   id="itemdescr" required="required"></td>
				</tr>
				
				<tr>
				<td align="left">Item Link:</td>	<td align="right"> <input name="itemlink" type="text"   id="itemlink" required="required"></td>
				</tr>
				<br />
				<br />
				<tr>
				<td align="left"><input type="submit" value="Submit" align="right"/> </td>	<td align="right"> <input type="reset" value="Clear" align="left"/> </td>
				</tr>
				</table>
				<br />
				<br />
