...
<div id="container">
            <div id="wrapper">
                <div id="top" align="center"> Administrator Registration </div>
                <div id="form">
                <form method="post" action="adminregisterationaction.php" name="register Form" id="registerform" enctype="multipart/form-data">
                	
                    <label>Username : </label>
                    <input type="text" autocomplete="off" align="center" name="username" id="user_id" class="username" />
                    <span class="check"  ></span> 
 					<br />
 					<br />
                    <label>Password : </label>
                    <input type="text" autocomplete="off" align="center" name="password" id="password_id" class="password" />
                    <br />
                    <br />
                    <br />
                    <label>Forname : </label>
                    <input type="text" autocomplete="off" align="center" name="firstname" id="firstname" class="firstname" />
                    <br />
                    <br />
                    <label>Surname : </label>
                    ...
                    <br />
                    <label>Email : </label>
                    <input type="text" autocomplete="off" align="center" name="email" id="email_id" class="email" />
                    <br />
                    <br />
                    <p align="center">
                    ...
                    if(availname!=''){
                        ...
                        $.ajax({
                            ...
                            success: function(result){
                                ...
                                if(result==''){
                                    $('.check').html('<img src="images/green-tick.png" /> Username Is Avaliable');
                                    $(".check").removeClass("red");
                                    $('.check').addClass("green");
                                    $(".user_name").removeClass("yellow");
                                    $(".user_name").addClass("white");
                                }else{
                                    $('.check').html('<img src="images/error_cross.png" /> Username Is Taken');
                                    $(".check").removeClass("green");
                                    $('.check').addClass("red")
                                    $(".user_name").removeClass("white");
                                    $(".user_name").addClass("bred");
                                }
                            }
                        });
                    }else{
...
<p align="center">Already registered? <a href="index.php">login</a> | <a href="adminlogin.php">admin login</a></p>
