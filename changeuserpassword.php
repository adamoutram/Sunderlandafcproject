...
<?php
 ...
 <h6 align="center">Change account password</h6>
			
				<p align="center">
				
				<?php echo $_SESSION["nopasswordchange"] ?>
				
				Your currently logged on as: <?php echo $_SESSION["authenticatedUser"] ?>
				<form method="post" action="changeuserpasswordaction.php" name="changepasswordform" id="changepasswordform" enctype="multipart/form-data">
