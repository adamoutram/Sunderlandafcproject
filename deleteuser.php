...
<?php
	...
	$query = "DELETE FROM SAFCusers WHERE user_ID = '$user_ID'" or die(mysqli_error());
	
	$result = (mysqli_query($con, $query));
	
if ($result == TRUE) {
	 echo "The user data was successfully deleted";
}

else {
	echo "The user data could not be deleted"; }
...
<br />
<p>Go back to Edit / Delete user <a href="admineditusers.php"><button type="button">Edit Users</button></a></p>
<br />
</div>
</body>
<div id="footer">
