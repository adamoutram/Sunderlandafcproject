...
<input type='submit' value='Match Report'>
		...
		"<br />";	
			...
			$query = "SELECT * FROM SAFCfixtures WHERE date BETWEEN '2013-10-01' AND '2013-10-31'" or die(mysqli_error());

		$result = (mysqli_query($con, $query));
		
		echo "<br />";
		echo "<h6 align='center'>October 2013</h6>";
		echo "<table border='1', width = '80%' id='fixturestable', border-color:'#D80000';>
...
<input type='submit' value='Match Report'>
		...
		$query = "SELECT * FROM SAFCfixtures WHERE date BETWEEN '2013-11-01' AND '2013-11-30'" or die(mysqli_error());

		$result = (mysqli_query($con, $query));
		
		echo "<br />";
		echo "<h6 align='center'>November 2013</h6>";
		echo "<table border='1', width = '80%' id='fixturestable', border-color:'#D80000';>
...
<input type='submit' value='Match Report'>
		...
		"<br />";	
			...
			$query = "SELECT * FROM SAFCfixtures WHERE date BETWEEN '2013-12-01' AND '2013-12-30'" or die(mysqli_error());

		$result = (mysqli_query($con, $query));
		
		echo "<br />";
		echo "<h6 align='center'>December 2013</h6>";
		echo "<table border='1', width = '80%' id='fixturestable', border-color:'#D80000';>
