...
//query the databse
		$query = "SELECT email FROM SAFCusers WHERE username='$Username' " or die(mysqli_error());
...
<br />
 ...
 <h6 align="center">Change account Email Address</h6>

<form method="post" action="changeuseremailaction.php" name="changeuseremailform" id="changeuseremailform" enctype="multipart/form-data">
			
				<p align="center">
				
				
				<?php echo $_SESSION["noemailchange"]; ?>
				
				Your current email is : <?php echo $rows['email']; } ?>
				<br />
				<br />
				 NEW EMAIL:	 <input name="newuseremail" type="text"   id="newuseremail" required="required">
				<br />
				<br />
