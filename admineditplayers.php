...
<?php
	    ...
	    $query = "SELECT * FROM firstteamsquad" or die(mysqli_error());

		$result = (mysqli_query($con, $query));
		
		echo "<br />";
		echo "<h6 align='center'>Edit / Delete Player Data</h6>";
		echo $_SESSION["playerUpdate"];
		echo $_SESSION["playerAdd"] ;
		echo "<br />";
		echo "<table border='1', width = '60%' id='fixturestable', border-color:'#D80000';>
...
<th width ='10%'></th>
		...
		while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
				...
				echo "<td>" . "<form name='deleteplayer' action='deleteplayer.php' method='get'>
...
<input type='submit' value='Delete'>
		...
		"<br />";	
				...
				echo "<td>" . "<form name='editplayer' action='editplayer.php' method='get'>
<input type='hidden' name='Player_ID' value=" . $row["Player_ID"] . ">
...
?>
<br />
<p>Add Player Data <a href="addplayer.php"><button type="button">Add Player</button></a></p>
<br />
