...
<?php	
	...
	$query = "SELECT * FROM firstteamsquad WHERE Player_ID = '$Player_ID'" or die(mysqli_error());
		...
		echo "<h6 align='center'>Edit Player Data</h6>";
		echo "<br />";
		echo "<form method='POST' action='editplayeraction.php' name='editplayer' id='editplayer' enctype='multipart/form-data'>";
		
				
	while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
		 			
			echo "Forename:<input name='forename' type='text' placeholder=". $row["forename"] ." id='forename' required='required'><br /><br />";
			...
			echo "Nationality :<input name='nationality' type='text' placeholder=". $row["nationality"] ." id='nationality' required='required'><br /><br />";
			
			echo "Position :<input name='position' type='text' placeholder=". $row["position"] ." id='position' required='required'><br /><br />";
			
			echo "Weight (kg) :<input name='weight' type='int' placeholder=". $row["weight"] ." id='weight' required='required'><br /><br />";
			
			echo "Height (cm) :<input name='height' type='int' placeholder=". $row["height"] ." id='height' required='required'><br /><br />";
			
			echo "Joined :<input name='joined' type='date' placeholder=". $row["joined"] ." id='joined' required='required'><br /><br />";
			
			echo "Bio :<textarea cols='40' rows='5' name='bio' id='bio' required='required'>". $row["bio"] ."</textarea><br /><br />";
			
			echo "<input type='hidden' name='Player_ID' value='$Player_ID' id='Player_ID'>";
